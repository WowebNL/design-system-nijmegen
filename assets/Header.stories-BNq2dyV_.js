import{H as v}from"./Header-Z0185p3U.js";import{H as h}from"./HtmlTransformer-CIQzRuZl.js";const H={title:"Components/Header/Html Implementation",id:"html-header",component:v,argTypes:{state:{name:"State",description:"Simulation of the state of the header items.",control:{type:"select"},options:["default","active","hover","focus-visible"]},expanded:{name:"Aria expanded",description:"Simulation of the aria-expanded attribute of all items in the header which can expand.",control:{type:"select"},options:["false","true"]},variant:{name:"Variant",control:{type:"select"},options:["default","funnel","account"],table:{disable:!0}},account:{name:"Account",control:{type:"boolean"},table:{disable:!0}}},args:{state:"default",expanded:"false",variant:""},parameters:{layout:"fullscreen",status:{type:"BETA"},docs:{source:{transform:h}}}},e={name:"Header",args:{variant:"default"}},a={name:"Funnel",args:{variant:"funnel",account:!1}},n={name:"Funnel ingelogd",args:{variant:"funnel",account:!0}},t={name:"Mijn omgeving",args:{variant:"account",account:!0}};var r,o,s;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  name: 'Header',
  args: {
    variant: 'default'
  }
