var L=(o,n,t)=>{if(!n.has(o))throw TypeError("Cannot "+t)};var i=(o,n,t)=>{if(n.has(o))throw TypeError("Cannot add the same private member more than once");n instanceof WeakSet?n.add(o):n.set(o,t)};var u=(o,n,t)=>(L(o,n,"access private method"),t);import{j as T}from"./jsx-runtime-CKrituN3.js";import{s as E,r as M,p as k}from"./server.browser-rAMDWieH.js";import{s as w}from"./index.min-B3hIxFls.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";const x=`<button class="nijmegen-toolbar-button" type="button" part="button">
  <slot></slot>
</button>
