var y=(o,e,n)=>{if(!e.has(o))throw TypeError("Cannot "+n)};var h=(o,e,n)=>{if(e.has(o))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(o):e.set(o,n)};var m=(o,e,n)=>(y(o,e,"access private method"),n);import{j as r}from"./jsx-runtime-CKrituN3.js";/* empty css                  */import{I as v}from"./IconChevronDown-xLOYuVOv.js";(function(){var a,M,l,f;function o(u,p){p===void 0&&(p={});var i=p.insertAt;if(!(!u||typeof document>"u")){var s=document.head||document.getElementsByTagName("head")[0],t=document.createElement("style");t.type="text/css",i==="top"&&s.firstChild?s.insertBefore(t,s.firstChild):s.appendChild(t),t.styleSheet?t.styleSheet.cssText=u:t.appendChild(document.createTextNode(u))}}var e=`/* stylelint-disable no-descending-specificity */
/**
 * @license EUPL-1.2
...
.nijmegen-progress-list .utrecht-paragraph,
nijmegen-progress-list .utrecht-paragraph {
...
.nijmegen-progress-list__details--active {
  display: flex;
}
...
.nijmegen-progress-list__sub-step--checked::after {
  border-color: var(--nijmegen-progress-list-connector-checked-border-color);
  border-inline-start-style: solid;
}`;o(e);var n=`<div class="progress-list">
  <slot></slot>
</div>
`;class c extends HTMLElement{constructor(){super();h(this,a);h(this,l);const i=document.createElement("template");i.innerHTML=n;const s=this.attachShadow({mode:"open"});s.appendChild(i.content.cloneNode(!0));const t=new CSSStyleSheet;t.replaceSync(e),s.adoptedStyleSheets=[t]}static get observedAttributes(){return["full"]}connectedCallback(){Array.from(this.children).forEach(i=>{i.addEventListener("click",s=>{const t=s.target.closest(".nijmegen-progress-list__button[aria-expanded]");t&&m(this,a,M).call(this,t)})})}}a=new WeakSet,M=function(i){const s=i.getAttribute("aria-expanded")==="true",t=i.getAttribute("aria-controls");if(i.setAttribute("aria-expanded",String(!s)),m(this,l,f).call(this,i,!s),t){const d=this.querySelector(`#${t}`);d&&d.classList.toggle("nijmegen-progress-list__details--active",!s)}},l=new WeakSet,f=function(i,s){var d;const t=((d=i.textContent)==null?void 0:d.trim())||"";s?i.setAttribute("aria-label",`${t} - Details verbergen`):i.setAttribute("aria-label",`${t} - Details tonen`)},customElements.define("nijmegen-progress-list",c)})();const D={steps:{name:"Steps",description:"Array of steps to display in the progress list",control:{type:"object"},table:{defaultValue:{summary:"[]"}}}},b=o=>{switch(o){case"checked":return"afgerond";case"current":return"huidige stap";case"not-checked":return"nog niet gestart";case"warning":return"waarschuwing in stap";case"error":return"fout in stap";default:return"nog niet gestart"}},k=({steps:o=[]})=>r.jsx("nijmegen-progress-list",{children:o.map((e,n)=>{var c,a;return r.jsxs("li",{className:`nijmegen-progress-list__step${e.status?` nijmegen-progress-list__step--${e.status}`:""}`,children:[r.jsx("div",{className:"nijmegen-progress-list__header",children:(c=e.subSteps)!=null&&c.length?r.jsxs("button",{className:"nijmegen-progress-list__button","aria-expanded":"false","aria-controls":`progress-details-${n}`,"aria-label":`Stap ${n+1} ${b(e.status)}: `,children:[e.heading,r.jsx(v,{})]}):r.jsxs("span",{children:[r.jsxs("span",{className:"nijmegen-sr-only",children:["Stap ",n+1," ",b(e.status),":"," "]}),e.heading]})}),r.jsx("div",{className:"nijmegen-progress-list__body",children:e.body&&(typeof e.body=="string"?r.jsx("p",{className:"utrecht-paragraph",children:e.body}):e.body)}),((a=e.subSteps)==null?void 0:a.length)&&r.jsx("ul",{className:"nijmegen-progress-list__details",id:`progress-details-${n}`,hidden:!0,children:e.subSteps.map((g,l)=>r.jsx("li",{className:`nijmegen-progress-list__sub-step${g.status?` nijmegen-progress-list__sub-step--${g.status}`:""}`,children:g.text},l))})]},n)})}),j=({steps:o=[]})=>r.jsx("ol",{className:"nijmegen-progress-list",children:o.map((e,n)=>{var c,a;return r.jsxs("li",{className:`nijmegen-progress-list__step${e.status?` nijmegen-progress-list__step--${e.status}`:""}`,children:[r.jsx("div",{className:"nijmegen-progress-list__header",children:(c=e.subSteps)!=null&&c.length?r.jsxs("button",{className:"nijmegen-progress-list__button","aria-expanded":"false","aria-controls":`progress-details-${n}`,"aria-label":`Stap ${n+1} ${b(e.status)}: `,children:[e.heading,r.jsx(v,{})]}):r.jsxs("span",{children:[r.jsxs("span",{className:"nijmegen-sr-only",children:["Stap ",n+1," ",b(e.status),":"," "]}),e.heading]})}),r.jsx("div",{className:"nijmegen-progress-list__body",children:e.body&&(typeof e.body=="string"?r.jsx("p",{className:"utrecht-paragraph",children:e.body}):e.body)}),((a=e.subSteps)==null?void 0:a.length)&&r.jsx("ul",{className:"nijmegen-progress-list__details",id:`progress-details-${n}`,hidden:!0,children:e.subSteps.map((g,l)=>r.jsx("li",{className:`nijmegen-progress-list__sub-step${g.status?` nijmegen-progress-list__sub-step--${g.status}`:""}`,children:g.text},l))})]},n)})});try{k.displayName="ProgressListStoryWebComponent",k.__docgenInfo={description:"",displayName:"ProgressListStoryWebComponent",props:{steps:{defaultValue:{value:"[] as Step[]"},description:"",name:"steps",required:!1,type:{name:"Step[]"}}}}}catch{}try{j.displayName="ProgressListStory",j.__docgenInfo={description:"",displayName:"ProgressListStory",props:{steps:{defaultValue:{value:"[] as Step[]"},description:"",name:"steps",required:!1,type:{name:"Step[]"}}}}}catch{}export{k as P,D as a,j as b};
