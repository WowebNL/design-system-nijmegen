var M=(o,r,l)=>{if(!r.has(o))throw TypeError("Cannot "+l)};var u=(o,r,l)=>{if(r.has(o))throw TypeError("Cannot add the same private member more than once");r instanceof WeakSet?r.add(o):r.set(o,l)};var s=(o,r,l)=>(M(o,r,"access private method"),l);import{j as a}from"./jsx-runtime-CKrituN3.js";/* empty css                  *//* empty css              */import{c as h}from"./clsx-B-dksMZM.js";import{I as V}from"./IconX-uKCbV2yY.js";import{I as z}from"./IconSearch-BrE3VivA.js";(function(){var c,k,d,E,b,L,p,S,f,T,_,A,g,N,j,I;function o(v,y){y===void 0&&(y={});var e=y.insertAt;if(!(!v||typeof document>"u")){var n=document.head||document.getElementsByTagName("head")[0],t=document.createElement("style");t.type="text/css",e==="top"&&n.firstChild?n.insertBefore(t,n.firstChild):n.appendChild(t),t.styleSheet?t.styleSheet.cssText=v:t.appendChild(document.createTextNode(v))}}var r=`/**
 * @license EUPL-1.2
...
.nijmegen-search {
  max-inline-size: var(--nijmegen-search-input-max-inline-size);
  position: relative;
}
...
.nijmegen-search__clear-button {
  ...
  cursor: pointer;
  display: flex;
  height: calc(100% - 1rem); /* stylelint-disable-line property-disallowed-list */
  justify-content: center;
  position: absolute;
  right: 0.5rem; /* stylelint-disable-line property-disallowed-list */
  top: 0.5rem; /* stylelint-disable-line property-disallowed-list */
}
.nijmegen-search__clear-button:focus-visible, .nijmegen-search__clear-button.nijmegen-search__clear-button--focus-visible {
...
`;class m extends HTMLElement{constructor(){super();u(this,c);u(this,d);u(this,b);u(this,p);u(this,f);u(this,_);u(this,g);u(this,j);const e=document.createElement("template");e.innerHTML=l;const n=this.attachShadow({mode:"open"});n.appendChild(e.content.cloneNode(!0));const t=new CSSStyleSheet;t.replaceSync(r),n.adoptedStyleSheets=[t]}static get observedAttributes(){return["full"]}connectedCallback(){const e=this.querySelector(".nijmegen-search__input"),n=this.querySelector(".nijmegen-search__clear-button"),t=this.querySelector(".nijmegen-listbox__list"),i=this.querySelector(".nijmegen-search__autocomplete-results");s(this,c,k).call(this),s(this,d,E).call(this,e,n),i&&i.classList.contains("nijmegen-search__autocomplete-results--example")&&s(this,b,L).call(this,e,n,t,i)}attributeChangedCallback(e,n,t){e==="full"&&n!==t&&s(this,c,k).call(this)}}c=new WeakSet,k=function(){const e=this.shadowRoot.querySelector(".nijmegen-search");e&&(this.hasAttribute("full")?e.classList.add("nijmegen-search--full-width"):e.classList.remove("nijmegen-search--full-width"))},d=new WeakSet,E=function(e,n){e&&n&&(e.addEventListener("input",()=>{s(this,p,S).call(this,e,n)}),n.addEventListener("click",()=>{e.value="",s(this,p,S).call(this,e,n),e.focus()}))},b=new WeakSet,L=function(e,n,t,i){e&&n&&t&&i&&(e.addEventListener("input",()=>{e.value.trim().length>=3?s(this,f,T).call(this,e.value,Z=>{s(this,_,A).call(this,Z,t,i)}):s(this,g,N).call(this,t,i)}),n.addEventListener("click",()=>{s(this,g,N).call(this,t,i)}))},p=new WeakSet,S=function(e,n){e.value.trim().length>0?n.classList.remove("nijmegen-search__clear-button--hide"):n.classList.add("nijmegen-search__clear-button--hide")},f=new WeakSet,T=function(e,n){const t=s(this,j,I).call(this,e),i=[{title:"Finibus "+t,url:"?q=1_"+t},{title:t+" elementum urna",url:"?q=2_"+t}];n(i)},_=new WeakSet,A=function(e,n,t){n.innerHTML=e.map(i=>`<li><a href="${i.url}" class="nijmegen-listbox__item">${i.title}</a></li>`).join(""),t.classList.add("nijmegen-search__autocomplete-results--show-results")},g=new WeakSet,N=function(e,n){e.innerHTML="",n.classList.remove("nijmegen-search__autocomplete-results--show-results")},j=new WeakSet,I=function(e){const n=document.createElement("p");return n.innerText=e,n.innerHTML},customElements.define("nijmegen-search",m)})();const D={placeholder:{name:"Placeholder",control:"text"},disabled:{name:"Disabled",control:"boolean"},readOnly:{name:"Read only",control:"boolean"},icon:{name:"Search icon",control:"boolean",table:{disable:!0}},dark:{name:"Dark mode",control:"boolean"},full:{name:"Full width",control:"boolean"},autocomplete:{name:"Autocomplete",control:"boolean",table:{disable:!0}},staticAutocomplete:{name:"Static autocomplete",control:"boolean"}},q=({icon:o=!0,disabled:r=!1,readOnly:l=!1,dark:m=!1,full:c=!1,autocomplete:x=!1,staticAutocomplete:d=!1,placeholder:w="Zoeken"})=>a.jsxs("nijmegen-search",{...c&&{full:""},children:[a.jsxs("div",{className:"nijmegen-search__container",children:[a.jsxs("div",{className:"nijmegen-search__input-holder",children:[a.jsx("input",{className:h("nijmegen-search__input",r&&"nijmegen-search__input--disabled"),disabled:r,readOnly:l,id:"search",type:"text",placeholder:w,"aria-controls":"autocomplete-results","aria-autocomplete":"both","aria-label":"Zoekveld"}),a.jsx("button",{className:"nijmegen-search__clear-button nijmegen-search__clear-button--hide","aria-label":"Invoer wissen",title:"Invoer wissen",children:a.jsx(V,{})})]}),a.jsxs("button",{className:h("utrecht-button utrecht-button--primary-action nijmegen-search__search-button",m&&"nijmegen-search__search-button--dark"),children:[o&&a.jsx(z,{})," Zoeken"]})]}),a.jsx("div",{className:h("nijmegen-search__autocomplete-results",x&&"nijmegen-search__autocomplete-results--example",d&&"nijmegen-search__autocomplete-results--static"),children:a.jsx("div",{className:"nijmegen-listbox",role:"listbox",children:a.jsx("ul",{className:"nijmegen-listbox__list",role:"list"})})})]}),C=({icon:o=!0,disabled:r=!1,readOnly:l=!1,dark:m=!1,full:c=!1,autocomplete:x=!1,staticAutocomplete:d=!1,placeholder:w="Zoeken"})=>a.jsxs("form",{className:h("nijmegen-search",c&&"nijmegen-search--full-width"),method:"GET",action:"",role:"search",children:[a.jsxs("div",{className:"nijmegen-search__container",children:[a.jsxs("div",{className:"nijmegen-search__input-holder",children:[a.jsx("input",{className:h("nijmegen-search__input",r&&"nijmegen-search__input--disabled"),disabled:r,readOnly:l,id:"search",type:"text",placeholder:w,"aria-controls":"autocomplete-results","aria-autocomplete":"both","aria-label":"Zoekveld"}),a.jsx("button",{className:"nijmegen-search__clear-button nijmegen-search__clear-button--hide","aria-label":"Invoer wissen",title:"Invoer wissen",tabIndex:"-1",children:a.jsx(V,{})})]}),a.jsxs("button",{className:h("utrecht-button utrecht-button--primary-action nijmegen-search__search-button",m&&"nijmegen-search__search-button--dark"),children:[o&&a.jsx(z,{})," Zoeken"]})]}),a.jsx("div",{className:h("nijmegen-search__autocomplete-results",x&&"nijmegen-search__autocomplete-results--example",d&&"nijmegen-search__autocomplete-results--static"),children:a.jsx("div",{className:"nijmegen-listbox",role:"listbox",children:a.jsx("ul",{className:"nijmegen-listbox__list",role:"list"})})})]});try{q.displayName="SearchStoryWebComponent",q.__docgenInfo={description:"",displayName:"SearchStoryWebComponent",props:{icon:{defaultValue:{value:"true"},description:"",name:"icon",required:!1,type:{name:"boolean"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean"}},readOnly:{defaultValue:{value:"false"},description:"",name:"readOnly",required:!1,type:{name:"boolean"}},dark:{defaultValue:{value:"false"},description:"",name:"dark",required:!1,type:{name:"boolean"}},full:{defaultValue:{value:"false"},description:"",name:"full",required:!1,type:{name:"boolean"}},autocomplete:{defaultValue:{value:"false"},description:"",name:"autocomplete",required:!1,type:{name:"boolean"}},staticAutocomplete:{defaultValue:{value:"false"},description:"",name:"staticAutocomplete",required:!1,type:{name:"boolean"}},placeholder:{defaultValue:{value:"Zoeken"},description:"",name:"placeholder",required:!1,type:{name:"string"}}}}}catch{}try{C.displayName="SearchStory",C.__docgenInfo={description:"",displayName:"SearchStory",props:{icon:{defaultValue:{value:"true"},description:"",name:"icon",required:!1,type:{name:"boolean"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean"}},readOnly:{defaultValue:{value:"false"},description:"",name:"readOnly",required:!1,type:{name:"boolean"}},dark:{defaultValue:{value:"false"},description:"",name:"dark",required:!1,type:{name:"boolean"}},full:{defaultValue:{value:"false"},description:"",name:"full",required:!1,type:{name:"boolean"}},autocomplete:{defaultValue:{value:"false"},description:"",name:"autocomplete",required:!1,type:{name:"boolean"}},staticAutocomplete:{defaultValue:{value:"false"},description:"",name:"staticAutocomplete",required:!1,type:{name:"boolean"}},placeholder:{defaultValue:{value:"Zoeken"},description:"",name:"placeholder",required:!1,type:{name:"string"}}}}}catch{}export{C as S,D as a,q as b};
